/*
  ...
  isValid: that checks if is a Harshad number or not
  getNext: returns the next Harshad number
  getSerie: that returns a series of n Harshad number, optional start value
            not included
*/
